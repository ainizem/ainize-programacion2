...
public class Main {
	...
	public static void main(String[] args) {
		...
		ventana.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // variable de clase accedemos a ella a través del
																// nombre de la clase
		...
		btnSumar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {// dentro del try vas las linea susceptibles al error y tmbn las dependientes
					...
					lblresultado.setText(String.valueOf(numero1 + numero2));// para convertir a string
				} catch (NumberFormatException e1) {
					lblresultado.setText("Introduce números");
				}
			}
